...
- Fix pending issue in 5.4.8 with trust store when using a custom ACME server from upstream

## 5.4.8

- Further improve root certificate handling when using a custom ACME server from upstream
